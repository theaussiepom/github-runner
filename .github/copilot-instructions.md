...
- Many tests compute `APPLIANCE_REPO_ROOT` and then `load` helper libraries.
...
This repo is intentionally minimal and does not assume any product-specific integrations.
If you add integrations (MQTT, hardware control, etc.), keep behavior strict and explicit and add tests.
