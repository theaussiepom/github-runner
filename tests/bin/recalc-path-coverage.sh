...
Prints path-coverage counts derived from:
  ...
  - tests/.tmp/runner-paths.unit.log
  - tests/.tmp/runner-paths.log
...
unit_log="$repo_root/tests/.tmp/runner-paths.unit.log"
integration_log="$repo_root/tests/.tmp/runner-paths.log"
